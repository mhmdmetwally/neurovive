...
## 🚀 Live Deployment
🌍 Base URL: https://neurovive.vercel.app/

## 📡 API
### POST /voice
Endpoint:
https://neurovive.vercel.app/voice
...
- Integrates with external services (AI, APIs, etc.)

- Runs on a scalable serverless infrastructure (Vercel)
